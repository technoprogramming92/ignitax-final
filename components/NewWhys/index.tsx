        ...
        <div className="flex flex-wrap -m-4">
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg">
              <div className="w-11 h-11 inline-flex items-center justify-center rounded-full bg-gray-800 text-purple-400 mb-4">
                <Image src="/images/itfeatures/Tax-bro.svg" alt="img1" width={125} height={125}></Image>
              </div>
